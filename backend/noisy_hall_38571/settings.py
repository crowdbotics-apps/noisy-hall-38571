"""
Django settings for noisy_hall_38571 project.
...
ROOT_URLCONF = 'noisy_hall_38571.urls'
...
WSGI_APPLICATION = 'noisy_hall_38571.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_hall_38571 API",
    "DESCRIPTION": "API documentation for noisy_hall_38571 App",
    "VERSION": "v1",
}
